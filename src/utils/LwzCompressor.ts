...
export class LzwCompressor {
  ...
  char_out(c: number, outs: BinaryWriter) {
  ...
  compress(init_bits: number, outs: BinaryWriter) {
  ...
  encode(pixels: Uint8Array, outs: BinaryWriter) {
    this.pixels = pixels;
  ...
  output(code: number, outs: BinaryWriter) {
